      ...
      <div class="container mx-auto px-6 max-w-4xl">
        ...
        <app-scroll-reveal preset="fade-up" [delay]="0">
          ...
          <p class="text-lg text-neutral-400 max-w-2xl leading-relaxed mb-12">
            Páginas web profesionales para empresas en Molina de Segura. Diseño moderno, SEO local y velocidad optimizada para posicionar tu negocio en la Vega Media del Segura.
          </p>
        </app-scroll-reveal>
        ...
        <app-scroll-reveal preset="fade-up" [delay]="0.1">
          <div class="grid md:grid-cols-2 gap-6 mb-16">
            <div class="glass-panel p-6 rounded-lg border border-white/10">
              <h3 class="text-white font-semibold mb-3">Posicionamiento en Molina</h3>
              <p class="text-neutral-400 text-sm leading-relaxed">Optimizamos tu web para búsquedas locales en Molina de Segura, Alcantarilla, Torres de Cotillas y toda la Vega Media.</p>
            </div>
            <div class="glass-panel p-6 rounded-lg border border-white/10">
              <h3 class="text-white font-semibold mb-3">Cercanía total</h3>
              <p class="text-neutral-400 text-sm leading-relaxed">Estamos a 10 minutos de Molina. Nos reunimos contigo en persona, entendemos tu mercado y diseñamos para tu público.</p>
            </div>
            <div class="glass-panel p-6 rounded-lg border border-white/10">
              <h3 class="text-white font-semibold mb-3">Web que convierte</h3>
            ...
            <div class="glass-panel p-6 rounded-lg border border-white/10">
              <h3 class="text-white font-semibold mb-3">Entrega rápida</h3>
              <p class="text-neutral-400 text-sm leading-relaxed">Tu web lista en 10-15 días. Desarrollo ágil con avances constantes y correcciones ilimitadas antes de la entrega final.</p>
            </div>
          </div>
        </app-scroll-reveal>
